...
const items: {
  ...
  {
    label: "所在地",
    value: "〒140-0014 東京都品川区大井3-18-18 Rex Oimachi 1F",
  },
  {
    label: "電話番号",
    value: "0120-19-7576",
  ...
  {
    label: "メールアドレス",
    value: "osouji.oimachi@gmail.com",
  },
  {
    label: "ウェブサイト",
  ...
  },
  {
    ...
    value: "サービス実施前のキャンセルは、前日18:00までにご連絡いただいた場合は無料です。当日キャンセルまたは無断キャンセルの場合、キャンセル料（サービス料金の50%）が発生する場合があります。\nサービス実施後に不備・不満がある場合は、サービス完了日より7日以内にご連絡ください。内容を確認の上、再施工または一部返金にて対応いたします。",
  },
  {
    label: "特記事項",
